var SentientBeing = function(blueprint) {
  ...
  var personalPronounsFor = function(pronoun, pronounCount) {
    return Array.apply(null, new Array(pronounCount)).map(Object.prototype.valueOf,pronoun);
  };

  var learnToComeALive = function(being, lifeFunc) {
    var pronounCount = lifeFunc.length;
    var thisPlusPronouns = [being].concat(personalPronounsFor(being, pronounCount));
    being.bringToLife = lifeFunc.bind.apply(lifeFunc, thisPlusPronouns);
  };
